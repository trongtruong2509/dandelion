...
const DeletePlaylistModal = ({ ...props }) => {
   ...
   return (
      <Modal {...props} className="w-[600px] p-5 text-primary bg-layout rounded-xl">
         ...
         <div className="flex items-center justify-end w-full gap-4 pt-4 pb-1">
            <button
            ...
            <button className="w-20 px-4 py-1 rounded-xl text-primary bg-dandelion-primary" onClick={onDelete}>
               OK
            </button>
         </div>
      </Modal>
